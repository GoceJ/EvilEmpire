        ...
        <form method="post" action="{{ route('post.update', ['post' => $post->id]) }}" autocomplete="off" class="form-horizontal">
          ...
          <div class="card ">
            <div class="card-header card-header-primary">
              ...
              <p class="card-category">{{ __('Post information') }}</p>
            </div>
            <div class="card-body ">
              ...
              <div class="row">
                ...
                <div class="col-sm-10">
                  <div class="form-group{{ $errors->has('desc') ? ' has-danger' : '' }}">
                    <input class="form-control{{ $errors->has('desc') ? ' is-invalid' : '' }}" name="desc" id="input-desc" type="text" placeholder="{{ __('Description') }}" value="{{ $post->desc }}" required />
                    @if ($errors->has('desc'))
